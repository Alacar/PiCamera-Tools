...
while confirm == 'y':
	...
	#Get amount of pictures per hour
	fph = input('How many pictures do you want per hour: ')
	while fph <= 0:
		fph = input('Incorrect amount of time. Try again: ')

	#Get how long the program should run for in hours
	duration = input('How many hours do you want to record for: ')
	while duration <= 0:
